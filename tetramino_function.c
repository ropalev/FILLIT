...
{
	if (map[x + tetramino->coord[2]][y + tetramino->coord[3]] > size ||
		map[x + tetramino->coord[2]][y + tetramino->coord[3]] < size ||
		map[x + tetramino->coord[4]][y + tetramino->coord[5]] > size ||
		map[x + tetramino->coord[4]][y + tetramino->coord[5]] < size ||
		map[x + tetramino->coord[6]][y + tetramino->coord[7]] > size ||
		map[x + tetramino->coord[6]][y + tetramino->coord[7]] < size)
		return (0);
	if (map[x + tetramino->coord[2]][y + tetramino->coord[3]] != 0 ||
